...
def main() -> None:
    ...
    print("Iniciando extração Practice Bronze...")
    ...
    try:
        ...
        extractor = RequestPractice(client, storage, table_loader)
        ...
        print(f"Extração Practice Bronze concluída em {elapsed:.2f} segundos.")
